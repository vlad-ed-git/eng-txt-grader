...
WSGI_APPLICATION = 'levlr.wsgi.application'
...
# since we shall handle translations ourselves
USE_I18N = False
...
STATIC_ROOT = os.path.join(BASE_DIR, 'collected_assets')
